...
class RobotControl():
    ...
    def __init__(self):
        ...
        self.vel_publisher = rospy.Publisher('/bot_0/cmd_vel', Twist, queue_size=1)
        self.laser_subscriber = rospy.Subscriber(
            '/bot_0/laser/scan', LaserScan, self.laser_callback)
        self.odom_subcriber =rospy.Subscriber(
            '/bot_0/odom', Odometry, self.odom_callback)     
